        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubjectTaught = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    ApplicationUserId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ClassFees_FeeTypes_FeeTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentParent", x => new { x.ChildrenId, x.ParentsId });
                    table.ForeignKey(
                        name: "FK_StudentParent_Parents_ParentsId",
                        column: x => x.ParentsId,
                        principalTable: "Parents",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudentParent_Students_ChildrenId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClassFees_ClassId_FeeTypeId",
                table: "ClassFees",
                columns: new[] { "ClassId", "FeeTypeId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ClassFees_FeeTypeId",
                table: "ClassFees",
                column: "FeeTypeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentFees_StudentId_FeeTypeId",
                table: "StudentFees",
                columns: new[] { "StudentId", "FeeTypeId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_StudentParent_ParentsId",
                table: "StudentParent",
                column: "ParentsId");
